...
//                val place = if (viewModel?.noneSelected?.value == true) PlaceUiModel() else {
//                    viewModel?.places?.value?.first { it.isSelected }
//                }?.toDomain() ?: return@setOnClickListener
...
//                listener = object : FindLocationDialog.Listener {
